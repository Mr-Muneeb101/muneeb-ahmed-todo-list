...
let tasks: string[] = []; // array of tasks

console.log(` \n \t ////////////////  Welocome to todolist of Muneeb Ahmed  \\\\\\\\\\\\\\\\ \t \n`); //Welcome Message
let condition: boolean = true;

const todolist = async () => { //main function
    while (condition) {
        let user_Input = await inquirer.prompt([  //asking user for operation
            {
                name: "userOperation",
                type: "list",
...
async function AddTask() { //add newTask
